...
function toggle() {
  if (lightOff == true) {
    document
      .querySelector("div .toggle-switch")
      .addEventListener("click", switchOn);
    ...
    function switchOn() {
      ...
      document.querySelector("nav .button").classList.add("glow");
      let lightOff = false;
      document
        .querySelector("div .toggle-switch")
        .addEventListener("click", switchOff);
      ...
      function switchOff() {
        ...
        document.querySelector("nav .button").classList.remove("glow");
        let lightOff = true;
        toggle();
      }
    }
